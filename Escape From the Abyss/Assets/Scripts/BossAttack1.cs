...
public class BossAttack1 : StateMachineBehaviour
{
	...
	override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		animator.gameObject.GetComponent<BossMovement>().ActivateSpike();
	...
	override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		//FindObjectOfType<BossMovement>().DeactivateSpike();
		//FindObjectOfType<BossMovement>().flee();
		animator.gameObject.GetComponent<BossMovement>().DeactivateSpike();
